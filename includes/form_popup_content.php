...
?>
<div
    class="devvn-popup-content-left <?php echo ($quickbuy_settings['popup_infor_enable'] == 1) ? '' : 'popup_quickbuy_hidden_mobile'; ?>">
...
<div class="devvn-popup-content-right">
    <form class="devvn_cusstom_info" id="devvn_cusstom_info" method="post">
        <div class="popup-customer-info">
            ...
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-2 popup-customer-info-name">
                    <input type="text" class="customer-name" name="customer-name"
                        placeholder="<?php _e('Full name', 'devvn-quickbuy'); ?>">
                </div>
                <div class="popup-customer-info-item-2 popup-customer-info-phone">
                    <input type="text" class="customer-phone" name="customer-phone"
                        id="your-phone-<?php echo $_randID; ?>"
                        placeholder="<?php _e('Phone number', 'devvn-quickbuy'); ?>">
                </div>
            </div>
            ...
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-1  popup-customer-info-valid-phone">
                    <input type="text" class="customer-valid-phone"
                        data-rule-equalTo="#your-phone-<?php echo $_randID; ?>" name="customer-valid-phone"
                        placeholder="<?php _e('Confirm your phone number', 'devvn-quickbuy'); ?>" />
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-1">
                    ...
                    <input type="text" class="customer-email" name="customer-email" data-required="true" required
                        placeholder="<?php _e('Email', 'devvn-quickbuy'); ?>">
                    <?php else: ?>
                    <input type="text" class="customer-email" name="customer-email" data-required="false"
                        placeholder="<?php _e('Email (Not required)', 'devvn-quickbuy'); ?>">
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-1">
                    <textarea class="customer-address" name="customer-address"
                        placeholder="<?php _e('Address', 'devvn-quickbuy'); ?> <?php echo ($quickbuy_settings['require_address'] == 0) ? __('(Not required)', 'devvn-quickbuy') : ''; ?>"></textarea>
                </div>
            </div>
            <?php endif; ?>
            <?php else: ?>
            ...
            <div class="popup-customer-info-group">
                ...
                <div class="popup-customer-info-item-3-23">
                    ...
                    <input name="require_district" id="require_district" type="hidden"
                        value="<?php echo $quickbuy_settings['require_district']; ?>" />
                </div>
                <div class="popup-customer-info-item-3-33">
                    ...
                    <input name="require_village" id="require_village" type="hidden"
                        value="<?php echo $quickbuy_settings['require_village']; ?>" />
                </div>
            </div>
            <?php if (!$quickbuy_settings['hidden_address']): ?>
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-1">
                    <input type="text" class="customer-address" name="customer-address"
                        placeholder="<?php _e('Street', 'devvn-quickbuy'); ?> <?php echo ($quickbuy_settings['require_address'] == 0) ? __('(Not required)', 'devvn-quickbuy') : ''; ?>" />
                </div>
            </div>
            <?php endif; ?>
            <?php endif; ?>
            ...
            <div class="popup-customer-info-group">
                <div class="popup-customer-info-item-1">
                    <textarea class="order-note" name="order-note"
                        placeholder="<?php _e('Note (Not required)', 'devvn-quickbuy'); ?>"></textarea>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="popup-customer-info-group popup-customer-info-radio paymentmethob-wrap">
                ...
                <label>
                    <input type="radio" name="customer-paymentmethob" value="<?php echo $gateway->id; ?>" <?php echo
                            ($stt == 1) ? 'checked' : ''; ?> />
                    <span>
            ...
            <div class="popup-customer-info-group customer_coupon_wrap">
                ...
                <div class="popup-customer-info-group customer_coupon_field">
                    <div class="popup-customer-info-item-2-3">
                        <input type="text" class="customer-coupon" name="customer-coupon"
                            placeholder="<?php _e('Coupon code', 'devvn-quickbuy'); ?>" />
                    </div>
        ...
        <input type="hidden" name="enable_ship" id="enable_ship"
            value="<?php echo $quickbuy_settings['enable_ship']; ?>">
        <input name="require_address" id="require_address" type="hidden"
            value="<?php echo $quickbuy_settings['require_address']; ?>" />
    </form>
</div>
<?php
        }
